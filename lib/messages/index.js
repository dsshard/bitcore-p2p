...
function Messages(options) {
  ...
  const defaultNetwork = bitcore.Networks.get(options.network) || bitcore.Networks.defaultNetwork
  this.network = typeof options.network === 'object' ? options.network : defaultNetwork;
}
